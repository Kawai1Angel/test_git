...
HD_PWD='C:/Users/15049/Desktop/CPU_learning/la32r_cpu/la32r_cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log la32r_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source la32r_top.tcl -notrace
